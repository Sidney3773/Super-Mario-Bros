...
function preload() {
    ...
    // URLs corregidas - usando CDN oficial de jsdelivr
    ...
    this.load.plugin('rexcheckboxplugin', 'https://cdn.jsdelivr.net/npm/phaser3-rex-plugins/dist/rexcheckboxplugin.min.js', true);
    this.load.plugin('rexsliderplugin', 'https://cdn.jsdelivr.net/npm/phaser3-rex-plugins/dist/rexsliderplugin.min.js', true);
    this.load.plugin('rexkawaseblurpipelineplugin', 'https://cdn.jsdelivr.net/npm/phaser3-rex-plugins/dist/rexkawaseblurpipelineplugin.min.js', true);
...
function generateLevel() {
    ...
    screenHeight - platformHeight * 1.4,
    'carrier_command',
    'INICIAR\n\nPARTIDA',
    screenWidth / 90
