...
function drawSettingsMenu() {
    ...
    let settingsText = this.add.text(screenWidth / 6, screenHeight - (screenHeight* 0.85), 'Configuracion', { fontFamily: 'pixel_nums', fontSize: (screenWidth / 45), align: 'center'});
    ...
    let musicCheckboxText = this.add.text(screenWidth / 8, screenHeight / 2.9, 'Musica', { fontFamily: 'pixel_nums', fontSize: (screenWidth / 55), align: 'center'}).setOrigin(0.5, 0).setInteractive().on('pointerdown', () => musicCheckbox.toggleChecked());;
